                ...
                try {
                        ...
                        if (clienteCount != null && clienteCount > 10 && vinoCount != null && vinoCount > 30) {
                                return ResponseEntity
                                                .ok("✅ Database already seeded with " + clienteCount + " clients and "
                                                                + vinoCount + " wines.");
                        }

                        // Insert 15 clients
                        // Insert 15 clients (Updated with credit columns)
                        jdbcTemplate.execute(
                                        "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio, limite_credito, riesgo_actual) VALUES ('c1000000-0000-0000-0000-000000000001', 'Restaurante El Calderito', 'B38456789', 'Restaurante', 'Ctra. Provincial 130', 'Santa Ursula', '38390', 'Santa Cruz de Tenerife', '922301122', 'info@elcalderito.com', 'Juan Perez', 10.00, 'Cliente preferente', true, 'Ctra. Provincial 130, Santa Ursula', 'Ctra. Provincial 130, Santa Ursula', 5000.00, 0.00)");
                        jdbcTemplate.execute(
                                        "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio, limite_credito, riesgo_actual) VALUES ('c1000000-0000-0000-0000-000000000002', 'Tasca El Granero', 'B38123456', 'Restaurante', 'C/ El Durazno 45', 'La Orotava', '38300', 'Santa Cruz de Tenerife', '922334455', 'reservas@tascaelgranero.com', 'Maria Lopez', 5.00, 'Buen consumo', true, 'C/ El Durazno 45, La Orotava', 'C/ El Durazno 45, La Orotava', 1000.00, 950.00)");
                        jdbcTemplate.execute(
                                        "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio, limite_credito, riesgo_actual) VALUES ('c1000000-0000-0000-0000-000000000003', 'Bodegon El Drago', 'B38789012', 'Restaurante', 'C/ Marques de Celada 2', 'Tegueste', '38280', 'Santa Cruz de Tenerife', '922543001', 'contacto@bodegoneldrago.com', 'Pedro Garcia', 15.00, 'Cliente historico', true, 'C/ Marques de Celada 2, Tegueste', 'C/ Marques de Celada 2, Tegueste', 2000.00, 0.00)");
                        jdbcTemplate.execute(
                                        "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio, limite_credito, riesgo_actual) VALUES ('c1000000-0000-0000-0000-000000000004', 'Hotel Botanico', 'B38234567', 'Hotel', 'Avda. Richard J. Yeoward 1', 'Puerto de la Cruz', '38400', 'Santa Cruz de Tenerife', '922381400', 'compras@hotelbotanico.com', 'Ana Martinez', 12.00, 'Hotel 5 estrellas', true, 'Avda. Richard J. Yeoward 1', 'Avda. Richard J. Yeoward 1', 10000.00, 0.00)");
