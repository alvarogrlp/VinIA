...
public class SeedDataController {
        ...
        public ResponseEntity<String> seedAll() {
                try {
                        ...
                        jdbcTemplate.execute("DELETE FROM asignaciones_cliente_comercial");
                        jdbcTemplate.execute("DELETE FROM lineas_pedido");
                        jdbcTemplate.execute("DELETE FROM pedidos");
                        jdbcTemplate.execute("DELETE FROM clientes");
                        jdbcTemplate.execute("DELETE FROM vino_maridajes");
                        jdbcTemplate.execute("DELETE FROM vinos");
