...
public class SeedDataController {
    ...
    public SeedDataController(JdbcTemplate jdbcTemplate) {
    ...
    public ResponseEntity<String> seedAll() {
        try {
            ...
            if (clienteCount != null && clienteCount > 10 && vinoCount != null && vinoCount > 30) {
                return ResponseEntity
                        .ok("✅ Database already seeded with " + clienteCount + " clients and " + vinoCount + " wines.");
            }

            // Insert 15 clients
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000001', 'Restaurante El Calderito', 'B38456789', 'Restaurante', 'Ctra. Provincial 130', 'Santa Ursula', '38390', 'Santa Cruz de Tenerife', '922301122', 'info@elcalderito.com', 'Juan Perez', 10.00, 'Cliente preferente', true, 'Ctra. Provincial 130, Santa Ursula', 'Ctra. Provincial 130, Santa Ursula')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000002', 'Tasca El Granero', 'B38123456', 'Restaurante', 'C/ El Durazno 45', 'La Orotava', '38300', 'Santa Cruz de Tenerife', '922334455', 'reservas@tascaelgranero.com', 'Maria Lopez', 5.00, 'Buen consumo', true, 'C/ El Durazno 45, La Orotava', 'C/ El Durazno 45, La Orotava')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000003', 'Bodegon El Drago', 'B38789012', 'Restaurante', 'C/ Marques de Celada 2', 'Tegueste', '38280', 'Santa Cruz de Tenerife', '922543001', 'contacto@bodegoneldrago.com', 'Pedro Garcia', 15.00, 'Cliente historico', true, 'C/ Marques de Celada 2, Tegueste', 'C/ Marques de Celada 2, Tegueste')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000004', 'Hotel Botanico', 'B38234567', 'Hotel', 'Avda. Richard J. Yeoward 1', 'Puerto de la Cruz', '38400', 'Santa Cruz de Tenerife', '922381400', 'compras@hotelbotanico.com', 'Ana Martinez', 12.00, 'Hotel 5 estrellas', true, 'Avda. Richard J. Yeoward 1', 'Avda. Richard J. Yeoward 1')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000005', 'Vinoteca La Barrica', 'B38345678', 'Tienda', 'C/ Castillo 15', 'La Laguna', '38201', 'Santa Cruz de Tenerife', '922259876', 'info@labarrica.com', 'Carlos Ruiz', 8.00, 'Tienda especializada', true, 'C/ Castillo 15, La Laguna', 'C/ Castillo 15, La Laguna')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000006', 'Restaurante El Rincón', 'B38456790', 'Restaurante', 'Plaza del Adelantado 3', 'La Laguna', '38201', 'Santa Cruz de Tenerife', '922631274', 'reservas@elrincon.com', 'Luis Fernandez', 10.00, 'Cocina tradicional', true, 'Plaza del Adelantado 3', 'Plaza del Adelantado 3')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000007', 'Parador de Las Cañadas', 'B38567891', 'Hotel', 'Carretera TF-21 Km 76', 'La Orotava', '38300', 'Santa Cruz de Tenerife', '922386415', 'reservas@parador.es', 'Isabel Gomez', 15.00, 'Parador Nacional', true, 'Carretera TF-21 Km 76', 'Carretera TF-21 Km 76')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000008', 'Tasca Los Abuelos', 'B38678902', 'Restaurante', 'C/ San Agustin 12', 'La Orotava', '38300', 'Santa Cruz de Tenerife', '922330987', 'info@losabuelos.com', 'Miguel Torres', 7.00, 'Cocina casera', true, 'C/ San Agustin 12', 'C/ San Agustin 12')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000009', 'Supermercados La Isla', 'B38789013', 'Distribuidor', 'Polígono Industrial 25', 'Santa Cruz', '38010', 'Santa Cruz de Tenerife', '922245678', 'compras@laisla.com', 'Roberto Diaz', 20.00, 'Cadena de supermercados', true, 'Polígono Industrial 25', 'Polígono Industrial 25')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000010', 'Restaurante La Hacienda', 'B38890124', 'Restaurante', 'Camino de La Hacienda 8', 'Los Realejos', '38410', 'Santa Cruz de Tenerife', '922340567', 'reservas@lahacienda.com', 'Carmen Suarez', 12.00, 'Restaurante de lujo', true, 'Camino de La Hacienda 8', 'Camino de La Hacienda 8')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000011', 'Hotel Rural Finca Salamanca', 'B38901235', 'Hotel', 'Camino de Salamanca 5', 'Güímar', '38500', 'Santa Cruz de Tenerife', '922514300', 'info@fincasalamanca.com', 'Antonio Ramirez', 10.00, 'Hotel rural boutique', true, 'Camino de Salamanca 5', 'Camino de Salamanca 5')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000012', 'Bodega y Tasca El Lagar', 'B38012346', 'Restaurante', 'C/ El Lagar 23', 'Tacoronte', '38350', 'Santa Cruz de Tenerife', '922560123', 'contacto@ellagar.com', 'Francisco Morales', 8.00, 'Especialidad en vinos locales', true, 'C/ El Lagar 23', 'C/ El Lagar 23')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000013', 'Catering Eventos Premium', 'B38123457', 'Catering', 'Polígono El Mayorazgo 45', 'Santa Cruz', '38110', 'Santa Cruz de Tenerife', '922289456', 'pedidos@eventospremium.com', 'Laura Navarro', 15.00, 'Eventos corporativos', true, 'Polígono El Mayorazgo 45', 'Polígono El Mayorazgo 45')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000014', 'Club Náutico Radazul', 'B38234568', 'Club', 'Muelle Deportivo s/n', 'El Rosario', '38130', 'Santa Cruz de Tenerife', '922680234', 'administracion@cnradazul.com', 'Javier Ortega', 10.00, 'Club náutico', true, 'Muelle Deportivo s/n', 'Muelle Deportivo s/n')");
            jdbcTemplate.execute(
                    "INSERT INTO clientes (id, nombre, cif, tipo, direccion, ciudad, codigo_postal, provincia, telefono, email, persona_contacto, descuento, notas, activo, direccion_facturacion, direccion_envio) VALUES ('c1000000-0000-0000-0000-000000000015', 'Restaurante Mirador de Garachico', 'B38345679', 'Restaurante', 'Plaza de la Libertad 1', 'Garachico', '38450', 'Santa Cruz de Tenerife', '922830000', 'info@miradorgarachico.com', 'Elena Castro', 12.00, 'Vistas al mar', true, 'Plaza de la Libertad 1', 'Plaza de la Libertad 1')");

            // Insert 35 wines
            jdbcTemplate.execute(
                    "INSERT INTO vinos (id, codigo_interno, nombre, bodega, tipo, ano, precio, denominacion_origen, grado_alcohol, descripcion, stock, stock_minimo, imagen_url, nota_cata, botellas_por_caja, formato_venta) VALUES ('v1000000-0000-0000-0000-000000000001', 'VIN-CAN-001', 'Vinatigo Baboso Negro', 'Bodegas Vinatigo', 'Tinto', 2020, 22.90, 'D.O. Valle de La Orotava', 13.50, 'Vino tinto de variedad autoctona', 45, 12, 'https://vinatigo.com/wp-content/uploads/2021/04/Baboso-Negro.jpg', 'Aromas a frutos rojos maduros', 6, 'BOTELLA')");
            jdbcTemplate.execute(
                    "INSERT INTO vinos (id, codigo_interno, nombre, bodega, tipo, ano, precio, denominacion_origen, grado_alcohol, descripcion, stock, stock_minimo, imagen_url, nota_cata, botellas_por_caja, formato_venta) VALUES ('v1000000-0000-0000-0000-000000000002', 'VIN-CAN-002', 'Vina Norte Listan Blanco', 'Bodegas Vina Norte', 'Blanco', 2022, 14.50, 'D.O. Tacoronte-Acentejo', 11.80, 'Vino blanco joven y fresco', 80, 15, 'https://bodegasinsulares.es/wp-content/uploads/2020/05/vina-norte-blanco-seco.jpg', 'Notas citricas y florales', 6, 'BOTELLA')");
            jdbcTemplate.execute(
                    "INSERT INTO vinos (id, codigo_interno, nombre, bodega, tipo, ano, precio, denominacion_origen, grado_alcohol, descripcion, stock, stock_minimo, imagen_url, nota_cata, botellas_por_caja, formato_venta) VALUES ('v1000000-0000-0000-0000-000000000003', 'VIN-CAN-003', 'Suertes del Marques Trenzado', 'Suertes del Marques', 'Tinto', 2021, 38.00, 'D.O. Valle de La Orotava', 14.00, 'Vino tinto de parcela vieja', 30, 8, 'https://suertesdelmarques.com/wp-content/uploads/2020/06/Trenzado.jpg', 'Complejo y elegante', 6, 'BOTELLA')");
            jdbcTemplate.execute(
                    "INSERT INTO vinos (id, codigo_interno, nombre, bodega, tipo, ano, precio, denominacion_origen, grado_alcohol, descripcion, stock, stock_minimo, imagen_url, nota_cata, botellas_por_caja, formato_venta) VALUES ('v1000000-0000-0000-0000-000000000004', 'VIN-CAN-004', 'Tajinaste Tradicional Tinto', 'Bodegas Tajinaste', 'Tinto', 2021, 9.50, 'D.O. Valle de La Orotava', 13.50, 'Vino tinto joven y fresco', 120, 20, 'https://bodegastajinaste.com/wp-content/uploads/2020/02/Tajinaste-Tradicional.jpg', 'Aromas a frutos rojos frescos', 6, 'BOTELLA')");
            jdbcTemplate.execute(
                    "INSERT INTO vinos (id, codigo_interno, nombre, bodega, tipo, ano, precio, denominacion_origen, grado_alcohol, descripcion, stock, stock_minimo, imagen_url, nota_cata, botellas_por_caja, formato_venta) VALUES ('v1000000-0000-0000-0000-000000000005', 'VIN-CAN-005', 'Tajinaste Blanco Afrutado', 'Bodegas Tajinaste', 'Blanco', 2022, 8.90, 'D.O. Valle de La Orotava', 12.50, 'Vino blanco joven y afrutado', 150, 25, 'https://bodegastajinaste.com/wp-content/uploads/2020/02/Tajinaste-Afrutado.jpg', 'Notas tropicales y citricas', 6, 'BOTELLA')");
            ...
            Integer finalClienteCount = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM clientes", Integer.class);
            Integer finalVinoCount = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM vinos", Integer.class);

            return ResponseEntity.ok("✅ Complete seed successful! Database now has " + finalClienteCount
